...
public class Program {
     ...
     *      Провести проверку принципа ISP. Создать дополнительный/е интерфейсы и имплементировать
     ...
     *      станция". Реализовать заправку каждого автомобиля подходящим топливом. Провести проверку
     *      принципа DIP.
     * @param args
     */
    public static void main(String[] args) {
        Harvester harvester1 = new Harvester("КамАЗ", "6522", Color.BLACK);

        RefuelingStation refuelingStation = new RefuelingStation();

        harvester1.setRefuelingStation(refuelingStation);
        harvester1.fuelType=FuelType.Gasoline;
        harvester1.fuel();

        CarWash carWash = new CarWash();

        harvester1.setCarWash(carWash);
        harvester1.wipMirrors();
        harvester1.wipHeadlights();
        harvester1.wipWindshield();

        Jeep jeep1 = new Jeep("Уаз", "Патриот", Color.red);

        jeep1.setRefuelingStation(refuelingStation);
        jeep1.fuel();

        jeep1.setCarWash(carWash);
        jeep1.wipMirrors();
        jeep1.wipHeadlights();
        jeep1.wipHeadlights();
